...
const TeamSection = ({ className = '' }: TeamSectionProps) => {
  ...
  const team = {
    founder: {
      ...
      role: 'Coach/Founder',
      image: '/images/team/cephas.jpg',
    },
    brainTrust: [
      { name: 'Dr. Ishaku Lemu', role: 'Advisor', image: '/images/team/caleb.jpg' },
      { name: 'Mrs. Martha Amin', role: 'Advisor', image: '/images/team/ayuni.jpg' },
      { name: 'Mr. Abdon Sadah', role: 'Advisor', image: '/images/team/yusuf.jpg' },
      { name: 'Mr. Samaila Bitrus', role: 'Advisor', image: '/images/team/andrawus.jpg' },
      { name: 'Mr. Mabe Budidi', role: 'Advisor', image: '/images/team/jude.jpg' },
      { name: 'Mr. Peter Ligari', role: 'Advisor', image: '/images/team/caleb.jpg' },
      { name: 'Mr. Gideon Mela', role: 'Advisor', image: '/images/team/yusuf.jpg' },
    ],
    management: [
      { name: 'Cephas Aaron', role: 'Executive Director', image: '/images/team/cephas.jpg' },
      { name: 'Caleb Sadah', role: 'Admin/Project Director', image: '/images/team/caleb.jpg' },
      { name: 'Jacob George', role: 'Program Coordinator', image: '/images/team/andrawus.jpg' },
      { name: 'Ayuni Titus', role: 'Program Coordinator', image: '/images/team/ayuni.jpg' },
      { name: 'Keturah Heman', role: 'Communications Officer', image: '/images/team/keturah.jpg' },
      ...
      { name: 'Andrawus Philip', role: 'Volunteer Coordinator', image: '/images/team/andrawus.jpg' },
      { name: 'Hannatu Saleh', role: 'Finance Officer', image: '/images/team/hannatu.jpg' },
      { name: 'Mary Kibirita', role: 'M&E Officer', image: '/images/team/mary.jpg' },
    ],
    board: [
      { name: 'Cephas Aaron', role: 'Board Member', image: '/images/team/cephas.jpg' },
      { name: 'Caleb Sadah', role: 'Board Member', image: '/images/team/caleb.jpg' },
      { name: 'Christian Gideon', role: 'Board Member', image: '/images/team/jude.jpg' },
      { name: 'Kabrang Nayako', role: 'Community Dev.', image: '/images/team/andrawus.jpg' },
      { name: 'Andrawus Philip', role: 'Board Member', image: '/images/team/andrawus.jpg' },
      { name: 'Ruth Lamiya', role: 'Project Dev. Officer I', image: '/images/team/keturah.jpg' },
      { name: 'Yusuf Karu', role: 'Human Resource Officer', image: '/images/team/yusuf.jpg' },
      { name: 'Mary Kibirita', role: 'M&E Expert', image: '/images/team/mary.jpg' },
      { name: 'Ayuni Titus', role: 'Communications', image: '/images/team/ayuni.jpg' },
      { name: 'Nyulama Panyi', role: 'Project Dev. Officer II', image: '/images/team/hannatu.jpg' },
    ],
    volunteers: [
      { name: 'Nyulama Panyi', role: 'Volunteer', image: '/images/team/hannatu.jpg' },
