...
const TeamSection = ({ className = '' }: TeamSectionProps) => {
  ...
  const team = {
    ...
    brainTrust: [
      { name: 'Dr. Ishaku Lemu', role: 'Advisor', image: '/images/aaron.jpg' },
      { name: 'Mrs. Martha Amin', role: 'Advisor', image: '/images/aaron.jpg' },
      { name: 'Mr. Abdon Sadah', role: 'Advisor', image: '/images/aaron.jpg' },
      { name: 'Mr. Samaila Bitrus', role: 'Advisor', image: '/images/aaron.jpg' },
      { name: 'Mr. Mabe Budidi', role: 'Advisor', image: '/images/aaron.jpg' },
      { name: 'Mr. Peter Ligari', role: 'Advisor', image: '/images/aaron.jpg' },
      { name: 'Mr. Gideon Mela', role: 'Advisor', image: '/images/aaron.jpg' },
    ],
    management: [
      { name: 'Cephas Aaron', role: 'Executive Director', image: '/images/aaron.jpg' },
      { name: 'Caleb Sadah', role: 'Admin/Project Director', image: '/images/caleb.jpg' },
      { name: 'Jacob George', role: 'Program Coordinator', image: '/images/jacob.jpg' },
      { name: 'Ayuni Titus', role: 'Program Coordinator', image: '/images/ayuni.jpg' },
      { name: 'Keturah Heman', role: 'Communications Officer', image: '/images/kate.jpg' },
      { name: 'Yusuf Karu', role: 'Project Dev. Officer', image: '/images/yusuf.jpg' },
      { name: 'Jude Joel', role: 'Executive Assistant', image: '/images/jude.jpg' },
      { name: 'Andrawus Philip', role: 'Volunteer Coordinator', image: '/images/andy.jpg' },
      { name: 'Hannatu Saleh', role: 'Finance Officer', image: '/images/hanny.jpg' },
    ],
    volunteers: [
      { name: 'Nyulama Panyi', role: 'Volunteer', image: '/images/barry.jpg' },
      { name: 'Mary Kibirita', role: 'Volunteer', image: '/images/mary.jpg' },
    ],
  };
